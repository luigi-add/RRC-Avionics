...
class serialPlot:
    ...
    def getIMUData(self, frame, lines, lineValueText, lineLabel, timeText, byteIndex):
        ...
        #                     self.data[3][-1],self.data[4][-1],self.data[5][-1],
        #                     self.data[6][-1],self.data[7][-1],self.data[8][-1],
        #                     self.data[9][-1],self.data[10][-1],self.data[11][-1],
        #                     self.data[12][-1],self.data[13][-1],self.data[14][-1],
        #                     self.data[15][-1]])
